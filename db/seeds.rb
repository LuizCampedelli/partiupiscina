...
Ofuro_Vidigal = Pool.new(user: User_Maria, name: "Ofurô no Vigigal", size: 2, price: 20_000, address: "R. Armando Almeida Lima, 8 - Vidigal, Rio de Janeiro", capacity: 20)
Ofuro_Vidigal.save!
...
Piscina_borda_infinita = Pool.new(user: User_Maria, name: "Piscina borda infinita Ilha Bela", size: 20, price: 50_000, address: "Rua Jackson de Figueiredo 501, Joatinga, Rio de Janeiro", capacity: 20)
